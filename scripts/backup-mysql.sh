...
ncftpput -V -t 3600 -u "backup" -p "backup123" home.codeone.pl /BigMike/mysql $BACKUPDIR.tar.gz
rsync --ignore-existing $BACKUPDIR.tar.gz backups@chuck.net-labs.pl:~/backup/bigmike/mysql/
